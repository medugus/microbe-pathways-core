...
export const meduguActions = {
  ...
  recordScientistSignOff: accessionStore.recordScientistSignOff,
  savePathologistComment: accessionStore.savePathologistComment,
  recordPathologistAuthorization: accessionStore.recordPathologistAuthorization,
