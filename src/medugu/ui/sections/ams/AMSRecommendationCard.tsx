...
export function AMSRecommendationCard({
  ...
  const ruleCode = governanceRuleCode ?? explanation.matchedRuleCode ?? row.expertRulesFired?.[0]?.ruleCode ?? row.ruleAppliedCode ?? "not available";
      ...
      <div className="rounded-md border border-border bg-background p-2 text-xs">
        ...
        <div className="mt-1">
          ...
          {ruleCode === "not available" ? (
            ...
            <a className="text-primary underline" href={`#ams-rule-${ruleCode}`}>{ruleCode}</a>
          )}
        </div>
