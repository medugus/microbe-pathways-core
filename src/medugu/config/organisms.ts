...
export const ORGANISMS: OrganismDef[] = [
  ...
  {
    code: "SPYO",
    display: "Streptococcus pyogenes (GAS)",
    gram: "gram_positive",
    group: "streptococcus",
  },
  {
    code: "SAGAL",
    display: "Streptococcus agalactiae (GBS)",
    gram: "gram_positive",
    group: "streptococcus",
  },
  {
  ...
  {
    code: "SDYS",
    display: "Streptococcus dysgalactiae / β-haemolytic groups C/G",
    gram: "gram_positive",
    group: "streptococcus",
  },
  {
    code: "SVIR",
    display: "Viridans group streptococci",
    gram: "gram_positive",
    group: "streptococcus",
  },
  ...
  { code: "GARD", display: "Gardnerella vaginalis", gram: "other", group: "other" },
  { code: "TVAG", display: "Trichomonas vaginalis", gram: "other", group: "other" },
 ...
 */
export const NON_GROWTH_ORGANISM_CODES: string[] = ORGANISMS.filter((o) => o.noAst).map(
  (o) => o.code,
);
